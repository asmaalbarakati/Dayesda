...
if(isset($_POST['enroll']))
{
	...
	//insert into the payemtn relation first..
	$query1 = "INSERT INTO PAYMENT(cardnumber,type,address) values('$card','$ct','$add')";
	$result = mysql_query($query1)
		or die (mysql_error());
		
	//insert into the completion relation second..	
	$query2 = "INSERT INTO COMPLETION(yearofcom,crid,tid,cardnumber) values('$year','$crChoice','$tid','$card')";
